#! /bin/bash
# Created by ScardracS and Licensed under the Apache License, Version 2.0 (the "License");
...
echo ""
echo "This script is developed & tested by me (ScardracS) for the Moto X Style."
echo "Feel free to use and/or modify, but please give me proper credits."
echo "I don't assume any responsibility if You damage your devices, You're been warned!"
echo ""
...
echo "Press any other values to stop the Script."
read A
case $A in
...
read B
case $B in
	Y) echo "Do you want to delete userdata? Please write Y/y or N/n. Any other values will stop the program!"
		read C
		case $C in
		Y)
			clear
